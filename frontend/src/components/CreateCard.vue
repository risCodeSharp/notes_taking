...
<template>
    <div class="relative flex flex-col rounded-xl bg-white p-4 py-8 md:py-12 shadow-sm w-full">
          <form class="flex flex-col items-center text-sm text-gray-700">
            <div class="w-full px-4 md:px-12 lg:px-20 xl:px-28">
              ...
              <label for="remember" class="flex items-center gap-2 mb-6 cursor-pointer">
                <input
                  id="remember"
                  type="checkbox"
                ...
                <p class="text-sm font-medium text-gray-600 select-none">
                  I agree with the
                  <a href="#" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-colors">
