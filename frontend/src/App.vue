          ...
          <div class="ml-2 mx-auto shadow-xl rounded-lg">
            <Tabs v-model="activeTab" v-bind="{} as any" class="pt-2">
              ...
              <TabPanels class="p-5 border border-t-0 border-gray-300 rounded-b-md bg-white">
                <EditorView :current-mode="currentMode" tab-number="0" v-model:markdown="tabvalue1" noteName="Q4 Project Strategy & Roadmap" />
                <EditorView :current-mode="currentMode" tab-number="1" v-model:markdown="tabvalue2" noteName="Test subject" />
                <EditorView :current-mode="currentMode" tab-number="2" v-model:markdown="tabvalue3" noteName="Big subject" />
              </TabPanels>
            </Tabs>
          </div>
        </main>
